      ...
      <div className="header-icon" style={{ height: '100%', paddingTop: '36px' }}>
        <a href="https://pxl.ru.altkraft.com/form?form=7sGW2395fA7V29r1WBjWb6DgJTJeDtpk67GN1m3geRRaEnYHfdANrimG8i7Vei7vnrgdeeifLD4EqpTJPNu3PxQc">
          <svg width="34" height="34" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path fillRule="evenodd" clipRule="evenodd" d="M4.65802 7.03958C4.91232 6.71262 5.38353 6.65372 5.71049 6.90802L12 11.7999L18.2896 6.90802C18.6165 6.65372 19.0877 6.71262 19.342 7.03958C19.5964 7.36654 19.5375 7.83775 19.2105 8.09205L12.4605 13.342C12.1897 13.5527 11.8104 13.5527 11.5396 13.342L4.78958 8.09205C4.46262 7.83775 4.40372 7.36654 4.65802 7.03958Z" fill="#1a2629"/>
          </svg>
        </a>
      </div>
    </header>
