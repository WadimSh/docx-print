...
export const config = [
  {
    ...
    options: [
      ...
      },
      {
        ...
        value: 'image-prices',
        description: 'Эти ценники имеют размер 4x10 см с информацией о товаре. На них есть изображение товара, а также артикул, название и бренд/страна изготовителя. Если товар продаётся поштучно, указана цена за одну штуку. Если продаётся в большом количестве, указана цена за единицу и за минимальную партию поставки. Ниже приведен пример создаваемого документа с указанными ценниками.',
      ...
      },
      {
        ...
        description: 'Эти ценники имеют размер 4x10 см и содержат информацию о товаре, включая изображение товара, артикул, название и бренд/страну изготовителя. Если товар продается поштучно, указана цена за одну штуку. Если продается оптом, указана цена за единицу и за минимальную партию. Также указан штрих-код минимальной единицы продажи. Ниже приведен пример документа с такими ценниками.',
